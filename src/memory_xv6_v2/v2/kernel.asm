...
801020f5:	a3 9c 26 11 80       	mov    %eax,0x8011269c
...
80102109:	8b 15 9c 26 11 80    	mov    0x8011269c,%edx
8010210f:	89 14 85 c0 26 11 80 	mov    %edx,-0x7feed940(,%eax,4)
  pids[index] = pidNum;
80102116:	8b 15 a0 26 11 80    	mov    0x801126a0,%edx
...
80102274:	a3 9c 26 11 80       	mov    %eax,0x8011269c
    r->pfn = framenumber;
...
80102282:	89 04 b5 c0 26 11 80 	mov    %eax,-0x7feed940(,%esi,4)
    pids[index] = pidNum;
80102289:	a1 a0 26 11 80       	mov    0x801126a0,%eax
